...
export const PostNewMessage = () => {
    ...
    async function submitNewQuestion() {
        ...
        if(authState?.isAuthenticated && title !== '' && question !== ''){
            const messageRequestMode: MessageModel = new MessageModel(title, question);
            const requestOptions = {
                ...
                body: JSON.stringify(messageRequestMode)
        ...
        <div className='card mt-3'>
            ...
            <div className='card-body'>
                <form method='POST'>
                    ...
                    {/* {displaySuccess && <div>...</div>}这种写法是一种常用的条件渲染技巧。根据displaySuccess的布尔值（真/假）来决定是否渲染后面的组件或元素。displaySuccess是一个状态变量,通过useState来控制 */}
